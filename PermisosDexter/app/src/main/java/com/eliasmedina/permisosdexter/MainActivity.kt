package com.eliasmedina.permisosdexter
...
import com.eliasmedina.permisosdexter.enums.PermissionStatusEnum
...
class MainActivity : Activity() {
   ...
   // private fun checkCameraPermissions() = setCameraPermissionHandlerWithDialog()
    ...
    private fun setCameraPermissionHandlerWithSnackBar () {
        ...
        val snackbarPermissionListner = SnackbarOnDeniedPermissionListener.Builder
        ...
        val composite = CompositePermissionListener(permission, snackbarPermissionListner )
