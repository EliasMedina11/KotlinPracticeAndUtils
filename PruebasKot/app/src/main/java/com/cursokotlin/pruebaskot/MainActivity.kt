...
import com.cursokotlin.pruebaskot.activities.*
...
class MainActivity : ToolbarActivity (){
    ...
    fun showSnackBar(){
        val layout = findViewById<ConstraintLayout>(R.id.vista)
        Snackbar.make(layout,"You have deleted this Email", Snackbar.LENGTH_LONG).setAction("UNDO"){
